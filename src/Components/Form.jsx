...
const Form = ({LoginHandler}) => {
  ...
  return (
    <div className='h-screen w-full'>
      <div className='w-full h-full bg-[url("../public/bg-2.jpeg")] bg-cover bg-center bg-no-repeat flex justify-center items-center'>
        <form className='h-1/2 sm:h-2/3 w-[90%] sm:w-3/4 rounded-3xl flex justify-center items-center flex-col frm' onSubmit={FormHandler}>
          <h1 className='text-4xl sm:text-6xl text-white font-bold mb-5 text-center'>Welcome to EndGaming AI</h1>
          <input
